    ...
    if (currentBg === 0) {
        if (obs.type === 'spike') {
            ...
            for (let x = obs.x; x < obs.x + obs.width; x += 15) {
                ctx.beginPath();
                ctx.moveTo(x, obs.height);
                ctx.lineTo(x + 7.5, obs.height - 12);
                ctx.lineTo(x + 15, obs.height);
                ctx.fill();
            }
        }
        ...
        if (obs.type === 'spike') {
            ...
            ctx.shadowBlur = 15;
            ctx.fillRect(obs.x + 5, obs.y, obs.width - 10, obs.height - 10);
            ctx.shadowBlur = 0;
        }
        ...
        if (obs.type === 'spike') {
            ...
            ctx.shadowColor = '#ff5252';
            ctx.shadowBlur = 15;
            ctx.fillRect(obs.x + 10, obs.y, obs.width - 20, obs.height - 5);
            ctx.shadowBlur = 0;
        }
    }
    ctx.restore();
